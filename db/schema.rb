...
ActiveRecord::Schema.define(version: 20131130183016) do
  ...
  add_index "membership_types", ["organization_id"], name: "index_membership_types_on_organization_id", using: :btree
